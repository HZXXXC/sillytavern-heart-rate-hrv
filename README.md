...
- **BLE Heart Rate Profile** (Bluetooth SIG, GATT Service `0x180D` / Characteristic `0x2A37`) — [官方规范](https://www.bluetooth.com/specifications/specs/heart-rate-service-1-0/)
- **Web Bluetooth API** — [W3C Community Group Draft](https://webbluetoothcg.github.io/web-bluetooth/)
- **HRV 时域指标 (RMSSD / SDNN / pNN50)** — Task Force of ESC/NASPE 1996 标准
- **SillyTavern Extension API** — [SillyTavern 官方文档](https://docs.sillytavern.app/for-contributors/writing-extensions/)

如果本仓库的某些代码片段你识别出来源自某个更早的开源项目（例如 SillyTavern 社区的某个心率扩展原型），**欢迎开 Issue 联系**，我会在 README 与 LICENSE 里明确补上 Attribution。本仓库初始化时未保留来源链路（无 git fork 关系），如有遗漏纯属无心。

## 许可

MIT — 代码可自由使用、修改、再分发。详见 [LICENSE](./LICENSE)。
